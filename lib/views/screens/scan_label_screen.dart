...
class ScanLabelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ScanViewModel>(builder: (context, vm, _) {
      if (vm.mode != ScanMode.productLabel) {
        WidgetsBinding.instance.addPostFrameCallback((_) => vm.setMode(ScanMode.productLabel));
      }
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Text('Scan Label', style: AppTextStyles.displaySmall),
                ...
                children: [
                  if (!vm.hasImage) ...[
                    CapturePromptCard(
                      ...
                      subtitle: 'Take a photo of any product\'s nutrition facts panel to get instant analysis.',
                  ...
                  if (vm.isAnalyzing)
                    const AnalyzingIndicator(
                      ...
                      subtitle: 'Extracting nutritional information',
                    ),
        ...
        GestureDetector(
          onTap: () {
            context.read<ChatViewModel>().setContext(
                  'I just scanned a nutrition label: ${info.name}. '
