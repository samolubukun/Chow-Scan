              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('ChowScan Chat', style: AppTextStyles.heading2),
                  ],
                ),
              ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Ask AI About Food', style: AppTextStyles.heading2),
            const SizedBox(height: 8),
            Text(
              'Chat with AI about nutrition, recipes, diet advice, or analyze food photos. Add photos using the + button.',
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: vm.isGenerating ? 'AI is thinking...' : 'Ask about food...',
                  filled: true,
                      ...
                      onTap: () async {
                        ...
                        if (path != null) {
                          ...
                          await vm.sendMultimodalMessage(
                            text.isEmpty ? 'Analyze this food image.' : text,
                            path,
                          );
                        }
                      },
